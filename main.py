...
def select_videos():
    video_paths = filedialog.askopenfilenames(filetypes=[("All compatible files", "*.mp4;*.avi;*.mkv;*.txt;*.csv"), ("Video files", "*.mp4;*.avi;*.mkv"), ("Playlist files", "*.txt;*.csv")])
    video_paths_list = []
